#!/bin/bash
#
# vchkuser: qmail-spp plugin to check existance of vpopmail users
#           and ezmlm mailing lists.
#           Based on vpopmail_check_recipient.sh 1.6 by Werner Maier
#
# Copyright 2007-2009 Benedikt Böhm <hollow@gentoo.org>
#
